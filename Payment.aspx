...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <button id="btnCart2" runat="server" class="btn btn-primary navbar-btn pull-right" onserverclick="btnCart2_ServerClick" type="button">
                        <i class="fas fa-cart-arrow-down"></i> <span id="CartBadge" runat="server" class="badge">0</span>
                    </button> 
             ...
             <div style="border-bottom: 1px solid #eaeaec;">
                ...
                <div>
                  ...
                  <div>
                    ...
                    <span class="float-right priceGray" id="spanPoints" runat="server"></span>
                </div>
            </div>
  ...
  <h3>Choose Payment Mode</h3>
            ...
            <ul class="nav nav-tabs">
             ...
             <div class="tab-content">
                 <button id="Button1" runat="server" onserverclick="btnRedeemPoints_Click"  class="btn btn-success navbar-btn pull-left "  type="button">
                         <span id="spanPointsTotal" runat="server" class="badge">0</span> <span >points</span> available
                    </button> <br /> <br /> <br />
                 <span class="font-weight-bold">Points Discount: <strong id="newPrice" runat="server">0</strong></span>
    ...
    <script
			src="https://kit.fontawesome.com/8f7c71be78.js"
