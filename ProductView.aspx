    ...
    <span class="sr-only">Next</span>
        ...
        <div class="col-md-5">
            ...
            <div class="divDet1">
                ...
                <span class="proOgPriceView">R <%#Eval("PPrice","{0:c}") %></span> <span class="proPriceDiscountView"> Off R <%# string.Format("{0}",Convert.ToInt64(Eval("PPrice"))-Convert.ToInt64(Eval("PSelPrice"))) %></span><p class="proPriceView"> <%#Eval("PSelPrice","{0:c}") %></p>
            </div>
            <div >
